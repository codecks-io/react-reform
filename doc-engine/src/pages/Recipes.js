    ...
    return (
      <Scaffold>
        ...
        <Section>
          ...
          <Applied comp={require('babel!comps/recipes/required-with-stars').default}/>
        </Section>
        <Section>
          ...
          <Applied comp={require('babel!comps/recipes/custom-button-text').default}/>
        </Section>
        <Section>
          ...
          <Applied comp={require('babel!comps/recipes/multiple-submit-theme').default}/>
          ...
          <Applied comp={require('babel!comps/recipes/multiple-submit-inline').default}/>
        </Section>
        <Section>
          ...
          <Applied comp={require('babel!comps/recipes/submit-on-blur').default}/>
        </Section>
        <Section>
          ...
          <Applied comp={require('babel!comps/recipes/dynamic-fields').default}/>
        </Section>
      </Scaffold>
    )
  }
